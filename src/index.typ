...
This is the documentation for *Nomai*, a fictional language spoken by the eponymous alien civilization from the video game #link("https://www.mobiusdigitalgames.com/outer-wilds.html")[_Outer Wilds_]. The documentation includes explanations of the language's phonology and grammar, a dictionary, and glossed translations of Nomai messages from the game. Some familiarity with linguistic concepts is assumed, but brief explanations are also provided in the footnotes.
